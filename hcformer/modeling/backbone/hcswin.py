...
# Modified by Teppei Suzuki from https://github.com/facebookresearch/Mask2Former/blob/main/mask2former/modeling/backbone/swin.py
...
from .utils import Clustering, TransformerEnc
...
class BasicLayer(nn.Module):
    """A basic Swin Transformer layer with clustering for one stage.
    Args:
...
class HCSwinTransformer(SwinTransformer, Backbone):
