...
# Modified by Teppei Suzuki from: https://github.com/facebookresearch/Mask2Former/blob/main/mask2former/modeling/transformer_decoder/mask2former_transformer_decoder.py
...
from .hcformer_decoder_mf import TRANSFORMER_DECODER_REGISTRY


def upsampling(preds, assigns):
    for a in assigns:
...
class HCTransformerDecoder(nn.Module):
    ...
    def forward(self, x, mask_features, assigns, mask = None):
