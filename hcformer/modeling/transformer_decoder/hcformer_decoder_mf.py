...
# Modified by Teppei Suzuki from: https://github.com/facebookresearch/Mask2Former/blob/main/mask2former/modeling/transformer_decoder/maskformer_transformer_decoder.py
...
class HCStandardTransformerDecoder(nn.Module):
    @configurable
    def __init__(
        self,
        in_channels,
