...
# Modified by Teppei Suzuki from: https://github.com/facebookresearch/Mask2Former/blob/main/mask2former/maskformer_model.py
...
from .modeling.backbone.utils import Clustering
from .modeling.backbone.resnet import HCResNet
