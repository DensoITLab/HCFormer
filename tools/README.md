This directory contains few tools for HCFormer.
...
Tool to analyze model parameters and flops, and visualize clustering resutls.
...
Usage for visualizing clustering resutls:

```
python tools/analyze_model.py --tasks vis --config-file CONFIG_FILE MODEl.WEIGHTS /path/to/checkpoint_file OUTPUT /path/to/output_dir
```
